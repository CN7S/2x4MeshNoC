...
analyze_fp_rail -nets {VDD VSS} -voltage_supply 1.80 -pad_masters {PVSS1W PVDD1W}
...
write_def -version 5.6 -placed -all_vias -blockages -routed_nets -specialnets -rows_tracks_gcells -output ../outputs/mesh_chip.def
